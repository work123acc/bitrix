			...
			<thead>
				<tr>
					...
					foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
						...
						?>
							<?//= $arHeader["name"]; ?>
							<? if ($arHeader["name"] !== 'Код') {echo $arHeader["name"]; } ?>
							</td>
					<?
					endforeach;
						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							?>
								...
								<td class="item">
									...
									<?php /*------------------------- Вывод кода под именем -------------------------*/ ?>
									
									<br><span>Код товара: <?= $arItem["PROPERTY_CODE_1C_VALUE"] ?></span>
							...
							?>
								...
								<?php /*------------------------- Отключаем вовод кода в таблице -------------------------*/ ?>
																
								<? if ($arHeader['name'] !== 'Код') { ?>
									<td class="custom">
