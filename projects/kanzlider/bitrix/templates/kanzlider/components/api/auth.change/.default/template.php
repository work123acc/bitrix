...
?>
<div class="container_auth_change">
	<div id="api_auth_change_<?=$arResult['FORM_ID']?>"
	     class="api_auth_change"
	     data-css="<?=$dataCss?>"
	     data-js="<?=$dataJs?>">

		<form id="api_auth_change_form_<?=$arResult['FORM_ID']?>"
		      method="post"
		      action="<?=$arResult["AUTH_FORM"]?>"
		      name="api_auth_change"
		      class="api_form">
			...
			<div class="api_error"></div>
                        ...
                        <div class="api_row" style="display: none;">
...
?>
	<script type="text/javascript">
		jQuery(document).ready(function ($) {
			$.fn.apiAuthChange({
				wrapperId: '#api_auth_change_<?=$arResult['FORM_ID']?>',
				formId: '#api_auth_change_form_<?=$arResult['FORM_ID']?>',
