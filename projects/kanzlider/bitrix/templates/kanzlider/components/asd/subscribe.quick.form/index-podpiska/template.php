...
<?$APPLICATION->IncludeComponent(
	...
	"EDIT_TEMPLATE" => "",
	"PATH" => SITE_DIR."include/index-podpiska-text.php"
	),
	false
);?>
...
<form action="<?= POST_FORM_ACTION_URI?>" method="post" id="asd_subscribe_form" class="info-block__subscription-form">
	...
	<div class="info-block__input-block  input-block--required">
		<input type="text" id="input-email" name="asd_email" value="" class="info-block__subscription-form-input  info-block__subscription-form-email" placeholder="E-mail"/>
	</div>
