					...
					<div class="goods__advanced-box">
						<div class="goods__advanced-button  goods__advanced-button--compare">
							...
							<? /*------------------------------- comment -----------------------------------------* ?>
								...
								<? /*------------------------------- comment -----------------------------------------*/ ?>
								<a href="/catalog/compare/" id="compare_<?=$item["OFFERS"][0]["ID"]?>"  />Уже в сравнении</a>
							
							<? } else { ?>
						<a href="javascript:void(0)" id="compare_<?=$item["OFFERS"][0]["ID"]?>" onclick="docomparespec(<?=$item["OFFERS"][0]["ID"]?>)" />Сравнить</a>
