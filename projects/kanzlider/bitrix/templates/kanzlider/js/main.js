$(document).ready(function(){
  ...
  $('.add_cart, .card__product-add-cart').click(function() {
  var popup_id = $('#add_to_basket');
  $(popup_id).fadeIn();
  ...
  $('.card__product-add-cart').click(function () {
    ...
    let price = (parent.attr('class') == 'card__product') ? parent.find('.card__product-price').html()
