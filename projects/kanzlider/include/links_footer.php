<a href="tel:8(3952) 53-55-55" class="footer__phone">8(3952) 53-55-55</a>
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"BRANCH_ACTIVE" => "N",
		"BUTTON_TEXT_BEFORE" => "",
		"CUSTOM_FIELDS" => array("Согласен с политикой конфиденциальности@input@type=checkbox@name=SOGLASIE@value=Да",""),
		"DATETIME" => "",
		"DEFAULT_OPTION_TEXT" => "-- Выбрать --",
		"DIR_URL" => "",
		"DISABLE_SEND_MAIL" => "N",
		"DISPLAY_FIELDS" => array("AUTHOR_NAME","AUTHOR_PERSONAL_MOBILE"),
		...
		"INSTALL_IBLOCK" => "N",
		"MODAL_BUTTON_CLASS" => "big-button footer__call-button",
		"MODAL_BUTTON_HTML" => "Заказать звонок",
		"MODAL_FOOTER_HTML" => "",
		"MODAL_HEADER_HTML" => "Заказать звонок",
		"MODAL_WIDTH" => "",
		...
		"REQUEST_VARS" => array("",""),
		"REQUIRED_FIELDS" => array("AUTHOR_NAME","AUTHOR_PERSONAL_MOBILE"),
...
<div class="footer__logo-text">
	 Оптовый интернет-магазин канцтоваров
</div>
 <a href="mailto:kanzlider22@irk.ru" class="footer__mail">kanzlider22@irk.ru</a> <a href="" class="footer__icq">491732612 </a>