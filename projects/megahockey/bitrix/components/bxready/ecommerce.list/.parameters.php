...
if (!Loader::includeModule('iblock') || !Loader::includeModule('alexkova.bxready'))
	return;
...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"USE_VOTE_RATING" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("IBLOCK_USE_VOTE_RATING"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"VOTE_DISPLAY_AS_RATING" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("IBLOCK_VOTE_DISPLAY_AS_RATING"),
			"TYPE" => "LIST",
			"MULTIPLE" => "N",
                        "VALUES" => array(
                            'rating'=>GetMessage("IBLOCK_VOTE_DISPLAY_RATING"),
                            'vote_avg'=>GetMessage("IBLOCK_VOTE_DISPLAY_VOTE_AVG")
                        ),
			"ADDITIONAL_VALUES" => "N",
			"DEFAULT" => "rating",
		),
