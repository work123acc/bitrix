...
<? if ($arResult['PROPERTIES']['VIDEO_TAB']['VALUE'] === 'Y') { ?>
	<div class="bxr-detail-tab bxr-detail-offers" data-tab="<?= $tabsArray['Видео'] ?>">
		<?= htmlspecialchars_decode($templateData['PR_TEXT'] ); ?>
	</div>
<? } ?>
...
<?
    ...
    <? if ($arResult['PROPERTIES']['BONUS']['VALUE'] === 'Y') { ?>
		<div class="bxr-detail-tab bxr-detail-offers" data-tab="<?= $tabsArray['Бонус'] ?>">
    ...
    <? if ($arResult['PROPERTIES']['GUARANTEE']['VALUE'] === 'Y') { ?>
		<div class="bxr-detail-tab bxr-detail-offers" data-tab="<?= $tabsArray['Гарантия'] ?>">
