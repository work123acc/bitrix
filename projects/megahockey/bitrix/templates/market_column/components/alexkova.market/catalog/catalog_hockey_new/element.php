...
if (!isset($arParams["USE_PRODUCT_QUANTITY"]))
    $arParams["USE_PRODUCT_QUANTITY"] = "Y";
if (!isset($arParams["SHOW_MAX_QUANTITY"]))
    $arParams["SHOW_MAX_QUANTITY"] = "Y";
if (!isset($arParams["SIDEBAR_DETAIL_SHOW"]))
    $arParams["SIDEBAR_DETAIL_SHOW"] = "Y";
global $moreSettings;
...
if ($isSidebar):
	...
	if ($isMenu):
	    $APPLICATION->IncludeComponent(
		    "alexkova.market:menu", isset($arParams["LEFT_MENU_TEMPLATE"]) ? $arParams["LEFT_MENU_TEMPLATE"] : "left", array(
...
<div class="<?= ($isSidebar) ? 'col-lg-9 col-md-9 ' : 'col-lg-12 col-md-12 ' ?>col-sm-12 col-xs-12" itemscope itemtype="http://schema.org/Product">
    ...
    $ElementID = $APPLICATION->IncludeComponent(
	    "bitrix:catalog.element", "element_new", array(
