					...
					<div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => SITE_DIR."include/footer_link_dvizhenie_head.php",
        ...
        <div class="container">
            ...
            <div class="row footerline">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 toggled-item">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 bxr-footer-col">
                                                    <?
                        $APPLICATION->IncludeComponent(
					...
					<div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => SITE_DIR."include/footer_link_dvizhenie.php",
                                "INCLUDE_PTITLE" => GetMessage("GHANGE_FOOTER_MENU")
                            ),
                            false
                        );?>
