...
<!--        <script type="text/javascript" src="https://code.jquery.com/jquery-1.11.3.js"></script>-->
	<? $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/js/jquery-1.11.3.js'); ?>
		<? $APPLICATION->AddHeadScript('https://client-shop-logistics.ru/catalog/view/javascript/pickup_vidjet.js'); ?>
		<? $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/js/shoplogistic.js'); ?>
	...
	<? if (SITE_ID === 's2' ) { ?>
		...
		<link rel="apple-touch-icon" sizes="180x180" href="<?= SITE_TEMPLATE_PATH ?>/images/favicon/mega/apple-touch-icon.png">
		<link rel="icon" type="image/png" sizes="32x32" href="<?= SITE_TEMPLATE_PATH ?>/images/favicon/mega/favicon-32x32.png">
		<link rel="icon" type="image/png" sizes="16x16" href="<?= SITE_TEMPLATE_PATH ?>/images/favicon/mega/favicon-16x16.png">
		<link rel="manifest" href="<?= SITE_TEMPLATE_PATH ?>/images/favicon/mega/site.webmanifest">
		<link rel="mask-icon" href="<?= SITE_TEMPLATE_PATH ?>/images/favicon/mega/safari-pinned-tab.svg" color="#3c59f0">
		<meta name="msapplication-config" content="<?= SITE_TEMPLATE_PATH ?>/images/favicon/mega/browserconfig.xml">
		<meta name="msapplication-TileColor" content="#ffffff">
		<meta name="msapplication-TileImage" content="<?= SITE_TEMPLATE_PATH ?>/images/favicon/mega/mstile-144x144.png">
