;(function(window) {
  ...
  MLMenu.prototype._init = function() {
    ...
    if( this.options.backCtrl ) {
      ...
      this.backCtrl.className = 'menu__back menu__back--hidden animated';
      this.backCtrl.setAttribute('aria-label', 'Go back');
      this.backCtrl.innerHTML = '<span class="icon icon__arrow-left">›</span><i class="icon__arrow-left_text">Назад</i>';
  ...
  MLMenu.prototype._menuOut = function(clickPosition) {
    ...
    if( this.options.direction === 'r2l' ) {
      ...
      currentMenu.currentMenu.add(isBackNavigation ? 'animate-outToLeft' : 'animate-outToRight');
    }
  };
        ...
        onEndAnimation(item, function() {
          ...
          if( !isBackNavigation ) {
            ...
            if( self.options.backCtrl ) {
              ...
              self.backCtrl.classList.remove('fadeOut');
              self.backCtrl.classList.add('fadeIn');
              categoriesTitle.classList.remove('fadeIn');
              categoriesTitle.classList.add('fadeOut');
            ...
            self.backCtrl.classList.remove('fadeIn');
            self.backCtrl.classList.add('fadeOut');
            categoriesTitle.classList.remove('fadeOut');
            categoriesTitle.classList.add('fadeIn');
